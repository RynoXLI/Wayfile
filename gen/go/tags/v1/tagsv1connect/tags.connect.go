...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/RynoXLI/Wayfile/gen/go/tags/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	TagServiceName = "tags.v1.TagService"
)
...
// NewTagServiceClient constructs a client for the tags.v1.TagService service. By default, it uses
...
func NewTagServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TagServiceClient {
	...
	tagServiceMethods := v1.File_tags_v1_tags_proto.Services().ByName("TagService").Methods()
...
// CreateTag calls tags.v1.TagService.CreateTag.
...
// GetTag calls tags.v1.TagService.GetTag.
func (c *tagServiceClient) GetTag(ctx context.Context, req *v1.GetTagRequest) (*v1.GetTagResponse, error) {
...
// ListTags calls tags.v1.TagService.ListTags.
...
// UpdateTag calls tags.v1.TagService.UpdateTag.
...
// DeleteTag calls tags.v1.TagService.DeleteTag.
...
// TagServiceHandler is an implementation of the tags.v1.TagService service.
...
func NewTagServiceHandler(svc TagServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/tags.v1.TagService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTagServiceHandler) CreateTag(context.Context, *v1.CreateTagRequest) (*v1.CreateTagResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tags.v1.TagService.CreateTag is not implemented"))
}

func (UnimplementedTagServiceHandler) GetTag(context.Context, *v1.GetTagRequest) (*v1.GetTagResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tags.v1.TagService.GetTag is not implemented"))
}

func (UnimplementedTagServiceHandler) ListTags(context.Context, *v1.ListTagsRequest) (*v1.ListTagsResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tags.v1.TagService.ListTags is not implemented"))
}

func (UnimplementedTagServiceHandler) UpdateTag(context.Context, *v1.UpdateTagRequest) (*v1.UpdateTagResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tags.v1.TagService.UpdateTag is not implemented"))
}

func (UnimplementedTagServiceHandler) DeleteTag(context.Context, *v1.DeleteTagRequest) (*v1.DeleteTagResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tags.v1.TagService.DeleteTag is not implemented"))
}
